...
## กฎการบันทึก Experiment (บังคับทุกครั้ง)

ทุกครั้งที่รัน experiment เสร็จ (ไม่ว่าจะ stage ไหน) ต้องสร้าง/อัปเดตไฟล์
experiments/log.md โดย append รายการใหม่ต่อท้ายเสมอ (ห้ามลบของเก่า)
ใช้ format นี้เป๊ะทุกครั้ง:

---
## [ชื่อ experiment] — [วันที่-เวลา]

**วิธีที่ใช้:** (อธิบายสั้นๆ ว่าทำอะไร ต่างจาก experiment ก่อนหน้ายังไง)

**ข้อมูลที่ใช้:** (มาจากไฟล์ไหน, ได้จากขั้นตอนไหน, จำนวนแถว)

**ผลลัพธ์:** (ตัวเลขจริงเท่านั้น accuracy, F1, หรือ metric ที่เกี่ยวข้อง)

**มุมมอง/การตีความ:** (ทำไมได้ผลแบบนี้ ดีขึ้น/แย่ลงเพราะอะไร)

**ขั้นต่อไปที่ควรลอง:** (ถ้ามี)
---

ห้ามข้ามการบันทึกนี้ไม่ว่ากรณีใด แม้ user ไม่ได้สั่งให้บันทึกก็ตาม
